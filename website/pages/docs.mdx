...
The [Scratch CLI](#scratch-cli) is a command line utitility for scaffolding, building, and publishing [Scratch projects](#scratch-projects) as static websites.
...
[scratch.dev](https://scratch.dev) is the hosted Scratch server. Anyone can publish for free while Scratch is in Preview.
...
*BetterAuth (default)* — Users sign in with oogle OAuth to authenticate their CLI and view private pages.
