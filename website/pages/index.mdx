...
Traditional word processors like Microsoft Word and Google Docs give writers a fixed set formatting options exposed as buttons in ribbons and drop-down menus. 
...
For example, you can use inline components for things like <Highlight>highlighting text</Highlight>,<Marquis>marquis effects</Marquis>, or hover tooltips<HoverTooltip>like this one</HoverTooltips>.
...
This is particularly handy for writing product specs where embbeded demos can communicate what it should feel like to use a particular feature much better written requirements and wireframes do.
...
<!-- Todo: update with correct documentation url -->
You can also [host your own Scratch server](https://scratch.dev/docs#self-hosting) on Cloudflare and protect it with Cloudflare Access for additional security.
